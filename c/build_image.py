"""Build the C tagtest Docker image on the HMI.  Normalizes tar
...
url = 'http://10.0.0.166:2375/build?t=bpclient-c-tagtest:dev&dockerfile=Dockerfile&rm=1'
